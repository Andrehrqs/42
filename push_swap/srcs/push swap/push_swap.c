...
int main (int argc, char **argv) //Define a program that takes in a random input if numbers and sorts them in ascending
{
	...
	if (!stact_sorted(a)) //Check if the stack is not sorted
	{
